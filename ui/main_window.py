...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.convertFAtoRGBtn.setGeometry(QtCore.QRect(10, 280, 120, 30))
        ...
        self.labelRecognition = QtWidgets.QLabel(self.groupBox_4)
        self.labelRecognition.setGeometry(QtCore.QRect(10, 30, 200, 16))
        self.labelRecognition.setScaledContents(False)
        self.labelRecognition.setObjectName("labelRecognition")
        self.edittext_test_word = QtWidgets.QLineEdit(self.groupBox_4)
        self.edittext_test_word.setGeometry(QtCore.QRect(10, 50, 140, 28))
        self.edittext_test_word.setObjectName("edittext_test_word")
        self.btn_test_word = QtWidgets.QPushButton(self.groupBox_4)
        self.btn_test_word.setGeometry(QtCore.QRect(160, 50, 90, 28))
        self.btn_test_word.setObjectName("btn_test_word")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton.setText(_translate("MainWindow", "Convert to FA"))
        ...
        self.labelRecognition.setText(_translate("MainWindow", "FA Sentence Recognition:"))
        self.btn_test_word.setText(_translate("MainWindow", "Test Word"))
