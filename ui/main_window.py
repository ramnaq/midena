...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.saveGrammarBtn = QtWidgets.QPushButton(self.verticalLayoutWidget_3)
        self.saveGrammarBtn.setObjectName("saveGrammarBtn")
        self.verticalLayout_2.addWidget(self.saveGrammarBtn)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.saveGrammarBtn.setText(_translate("MainWindow", "Save"))
